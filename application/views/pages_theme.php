...
<html lang="en">
  ...
  <body class="sidebar-expand-lg bg-body-tertiary">
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="#" class="nav-link" id="menu-kontak">Kontak</a></li>
          </ul>
            ...
            >
              ...
              <li class="nav-item">
                <label class="nav-link" style="cursor:pointer;">
                  <input type="radio" name="multi_level" class="form-check-input me-2" value="1" checked /> Tingkat 1
                </label>
                <ul style="list-style:none; padding-left:20px;">
                  <li>
                    <label class="nav-link" style="cursor:pointer;">
                      <input type="radio" name="multi_level" class="form-check-input me-2" value="2" /> Tingkat 2
                    </label>
                    <ul style="list-style:none; padding-left:20px;">
                      <li>
                        <label class="nav-link" style="cursor:pointer;">
                          <input type="radio" name="multi_level" class="form-check-input me-2" value="3" /> Tingkat 3
                        </label>
                      </li>
                    </ul>
                  </li>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#" id="breadcrumb-home">Rumah</a></li>
                  <li class="breadcrumb-item"><a href="#" id="breadcrumb-theme">Kustomisasi Tema</a></li>
                </ol>
              </div>
              <!--end::Col-->
            </div>
    ...
    <!--end::Script-->
    <script>
    function showMultiLevelContent(val) {
      document.getElementById('multi-level-content-1').style.display = val==1 ? 'block' : 'none';
      document.getElementById('multi-level-content-2').style.display = val==2 ? 'block' : 'none';
      document.getElementById('multi-level-content-3').style.display = val==3 ? 'block' : 'none';
    }
    document.querySelectorAll('input[name="multi_level"]').forEach(function(radio) {
      radio.addEventListener('change', function() {
        document.querySelectorAll('input[name="multi_level"]').forEach(function(r) {
          r.parentElement.classList.remove('active');
        });
        if (radio.checked) {
          radio.parentElement.classList.add('active');
          showMultiLevelContent(radio.value);
        }
      });
    });
    document.addEventListener('DOMContentLoaded', function() {
      showMultiLevelContent(document.querySelector('input[name="multi_level"]:checked').value);
    });
    </script>
    <!-- Konten Multi Level -->
    <div id="multi-level-content-1"><h4>Konten Tingkat 1</h4><p>Ini adalah konten untuk Tingkat 1.</p></div>
    <div id="multi-level-content-2" style="display:none"><h4>Konten Tingkat 2</h4><p>Ini adalah konten untuk Tingkat 2.</p></div>
    <div id="multi-level-content-3" style="display:none"><h4>Konten Tingkat 3</h4><p>Ini adalah konten untuk Tingkat 3.</p></div>
    <!-- Konten Kontak -->
    <div id="kontak-content" style="display:none">
      <h4>Kontak</h4>
      <p>Silakan hubungi kami di <a href="mailto:admin@example.com">admin@example.com</a> atau telepon 0812-3456-7890.</p>
    </div>
    <script>
    document.getElementById('menu-kontak').addEventListener('click', function(e) {
      e.preventDefault();
      document.getElementById('multi-level-content-1').style.display = 'none';
      document.getElementById('multi-level-content-2').style.display = 'none';
      document.getElementById('multi-level-content-3').style.display = 'none';
      document.getElementById('kontak-content').style.display = 'block';
    });
    </script>
    <script>
    document.getElementById('breadcrumb-theme').addEventListener('click', function(e) {
      e.preventDefault();
      // Tampilkan konten default Theme (Tingkat 1)
      document.getElementById('kontak-content').style.display = 'none';
      document.querySelector('input[name="multi_level"][value="1"]').checked = true;
      document.querySelector('input[name="multi_level"][value="1"]').dispatchEvent(new Event('change'));
    });
