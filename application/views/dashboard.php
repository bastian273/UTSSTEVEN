            ...
            >
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo site_url('dashboard/v2'); ?>" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Dashboard v2</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo site_url('dashboard/v3'); ?>" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Dashboard v3</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/theme'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/layout'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/ui'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/forms'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/tables'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/auth'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('pages/docs'); ?>" class="nav-link">
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo base_url('assets/img/user7-128x128.jpg'); ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo base_url('assets/img/user5-128x128.jpg'); ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo base_url('assets/img/user6-128x128.jpg'); ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
